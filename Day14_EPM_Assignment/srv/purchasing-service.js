...
module.exports = function () {
  ...
  this.on('submit', 'PurchaseOrders', async (req) => {
    ...
    const { PurchaseOrders, PurchaseOrderItems, Suppliers } = cds.entities('com.epm');
  ...
  this.on('reject', 'PurchaseOrders', async (req) => {
    ...
    const { PurchaseOrders } = cds.entities('com.epm');
  ...
  this.on('receive', 'PurchaseOrders', async (req) => {
    ...
    const { PurchaseOrders, PurchaseOrderItems, Products } = cds.entities('com.epm');
